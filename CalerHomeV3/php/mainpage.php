...
<html>
   ...
   <body>
      ...
      <div class="topnavigatorbar" id="myTopnav">
         ...
         <a href="shoppingcart.php" class="left"><i class="fa fa-shopping-cart"></i> Your Cart</a>
         <a href="paymenthistory.php" class="left"><i class="fa fa-cc-visa"></i> Payment History</a>
      </div>
      <div class="main">
      <div class="row-single">
      <div class="card-header" type="submit">
      <h3>Welcome To Caler Home</h3>
...
foreach ($rows as $products)
{
    ...
    echo "<a href='productdetail.php?primg=$primg&proid=$proid&proname=$proname&protype=$protype&prodes=$prodes&proprice=$proprice&qty=$qty&dateadd=$dateadd' name='productdetail'><img src='$imgurl' class='primage'></a>";
