...
if ($_SESSION["email"])
{
    $sqlloadpayment = "SELECT * FROM PAYMENT ORDER BY DATE DESC ";
...
{
    echo " <div class='card'>";
    echo "<h3 align='center' >Customer's Order Id: " . ($products['ORDERID']) . "</h3>";
    echo "<p class='price' align='left' > Paid by: " . ($products['FNAME'] . ' ' . $products['LNAME']) . " </p>";
    echo "<p class='price' align='left' > User Email: " . ($products['EMAIL']) . " </p>";
    echo "<p class='price' align='left' > Contact Number: " . ($products['PHONE']) . " </p>";
