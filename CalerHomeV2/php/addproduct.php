<?php 
   include_once("dbconnect.php");
    ...
    $sqladdproduct = "INSERT INTO FURNITURE(PRODUCTID,PRODUCTNAME,PRODUCTTYPE,PRODUCTPRICE,PRODUCTQUANTITY) VALUES('$pid','$pname','$ptype','$pprice','$pqty')";
...
<html>
   ...
   <body>
      ...
      <div class="topnavigatorbar" id="myTopnav">
         <a href="mainpageadmin.php" class="right">MainPage</a>
      </div>
      <div class="main">
         <div class="container">
            <form name="AddProductForm" action="../php/addproduct.php" onsubmit=""
               ...
               <div class="row">
                  <div class="col-25">
                     <label for="quantity">Furniture Quantity</label>
                  </div>
                  <div class="col-75">
